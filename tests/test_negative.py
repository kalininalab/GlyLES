...
class TestNegatives:
    ...
    @pytest.mark.parametrize("case", ["Glca(c1-2)Glc", "Glcb(ab1-2)Glc", "Glca(a11-2)Glc", "Glcb(a 1-2)Glc",
                                      "Glca(a1-21)Glc", "Glcb{a1-2}Glc", "Glca[a1-2]Glc", "Glcb[a1-2)Glc",
                                      "Glca(a1-2]Glc", "Glcb(1-2)Glc", "Glca(a-2)Glc", "Glcb(a1-)Glc", "Glca(a12)Glc",
                                      "Glcpa(c1-2)Glc", "Glcfb(ab1-2)Glc", "Glcfa(a11-2)Glc", "Glcpb(a 1-2)Glc",
                                      "Glcpa(a1-21)Glc", "Glcfb{a1-2}Glc", "Glcfa[a1-2]Glc", "Glcpb[a1-2)Glc",
                                      "Glcpa(a1-2]Glc", "Glcfb(1-2)Glc", "Glcfa(a-2)Glc", "Glcpb(a1-)Glc",
                                      "Glcfa(a12)Glc", "Glcp(c1-2)Glc", "Glcf(ab1-2)Glc", "Glcf(a11-2)Glc",
                                      "Glcp(a 1-2)Glc", "Glcp(a1-21)Glc", "Glcf{a1-2}Glc", "Glcf[a1-2]Glc",
                                      "Glcp[a1-2)Glc", "Glcp(a1-2]Glc", "Glcf(1-2)Glc", "Glcf(a-2)Glc", "Glcp(a1-)Glc",
                                      "Glcf(a12)Glc", "[Mana(b1-4)Glcb(a1-2)Glc", "Manf](b1-4)Glca(a1-2)Glc",
