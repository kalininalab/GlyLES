...
def parse(smiles, **kwargs):
    ...
    Args:
        smiles (str): IUPAC string of a glycan to be converted to SMILES. The SMILES might currently not end with an
    ...
    if "(" not in smiles:
        g = nx.DiGraph()
        g.add_node(0, type=monomer_from_string(smiles, **kwargs))
