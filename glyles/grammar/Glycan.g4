...
SAC:
    ...
    | 'Fus' | 'Ko' | 'Sug' | 'Xlu' | 'Yer' | 'Vio' | 'Sed' | 'Ins' | 'Ace' | 'Aco' | 'Asc' | 'Pau' | 'Erwiniose'
    | 'Per';
MOD:
...
FG:
    ...
    | 'Myr' | 'Non' | 'Oco' | 'Ole' | 'Orn' | 'Pam' | 'Pro' | 'Pyr' | 'Ser' | 'Sin' | 'Ste' | 'Thr' | 'Vac'
    | 'Ulo' | 'ulo'
    | 'Ac' | 'Am' | 'Bn' | 'Br' | 'Bz' | 'Cl' | 'Cm' | 'DD' | 'DL' | 'DL-' | 'Et' | 'Fo' | 'Gc' | 'Gr' | 'LD' | 'LL' | 'Me'
